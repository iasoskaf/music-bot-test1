module.exports = {
  Admins: ["291260371644317698", "359404460105007104"], // Admins of the bot, I don't know what this do. -Darren.
  ExpressServer: true, // If you wanted to make the website run or not
  DefaultPrefix: process.env.Prefix || ">", // Default prefix, Server Admins can change the prefix
  Port: 3000, //Which port website gonna be hosted
  SupportServer: "https://discord.gg/sbySMS7m3v", // Support Server Link
  Token: process.env.Token || "MTEyNjk4MzIwNjUzMzYwMzM5OA.GSRUMK.fq1ZbUUNSJ3DqHI1Psb5SeEOuSgXvQiL0iUmKI", // Discord Bot Token
  ClientID: process.env.Discord_ClientID || "1126983206533603398", // Discord Client ID
  ClientSecret: process.env.Discord_ClientSecret || "ESlJsQrNhnPk3UXZh-vv3b89foeqCEYl", // Discord Client Secret
  ...
  Spotify: {
    ClientID: process.env.Spotify_ClientID || "ff547555953043c79bdf2a2fb23efffa", // Spotify Client ID
    ClientSecret: process.env.Spotify_ClientSecret || "1e4a55c413a6463e9e2c723c945c2b70", // Spotify Client Secret
  },
};
